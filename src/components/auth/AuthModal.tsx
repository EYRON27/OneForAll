...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, defaultTab = 'login' }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm" onClick={onClose}>
      <div className="relative w-full max-w-4xl mx-4 bg-[#4b5f86] rounded-2xl overflow-hidden shadow-2xl" onClick={e => e.stopPropagation()}>
        {/* Close button */}
        <button 
          onClick={onClose}
          ...
          <div className="w-full md:w-3/5 p-8 md:p-16">
            ...
            <div className="flex gap-4 mb-8">
              <button
                ...
                className={`text-2xl font-bold pb-2 transition-all ${
                  activeTab === 'login' 
                    ? 'text-[#ff7a2d] border-b-2 border-[#ff7a2d]' 
            ...
            {activeTab === 'login' && (
              <div className="text-white">
                <h1 className="text-7xl font-extrabold text-[#ff7a2d] mb-4" style={{ 
                  textShadow: '3px 3px 0px rgba(0,0,0,0.8), -1px -1px 0px rgba(0,0,0,0.3)'
                }}>
                  Login
                </h1>
                <p className="text-lg text-white/90 mb-10">make yourself secure and productive.</p>
            ...
            {activeTab === 'signup' && (
              <div className="text-white">
                ...
                <p className="text-lg text-white/90 mb-10">and get your work done!</p>
