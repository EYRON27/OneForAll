...
const CreateCategoryModal: React.FC<CreateCategoryModalProps> = ({ isOpen, onClose, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4" onClick={onClose}>
      ...
      >
        <h2 className="text-[#ff7a2d] text-2xl font-bold mb-8 text-center">Create Category</h2>
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="Personal Money" className="bg-[#1a1a1a]">Personal Money</option>
